...
public class ConfiguracionJPA {
	...
	private boolean generateStaristics;
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean (DataSource dataSource) {
		...
		entityManagerFactoryBean.setJpaVendorAdapter(vendorDaptador());
	...
	private HibernateJpaVendorAdapter vendorDaptador() {
	...
	private Properties jpaHibernateProperties() {
		...
		properties.put(PROPERTY_NAME_HIBERNATE_GENERATE_STATISTICS, generateStaristics);
